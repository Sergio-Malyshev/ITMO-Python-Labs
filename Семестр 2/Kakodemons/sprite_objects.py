...
class Sprites:
    def __init__(self):
        ...
        self.list_of_objects = [
            ...
            SpriteObject(self.sprite_parameters['npc_devil'], (2.5, 1.5)),
            SpriteObject(self.sprite_parameters['npc_devil'], (5.51, 1.5)),
            SpriteObject(self.sprite_parameters['npc_devil'], (6.61, 2.92)),
            SpriteObject(self.sprite_parameters['npc_devil'], (7.68, 1.47)),
            SpriteObject(self.sprite_parameters['npc_devil'], (8.75, 3.65)),
            SpriteObject(self.sprite_parameters['npc_devil'], (1.27, 11.5)),
            SpriteObject(self.sprite_parameters['npc_devil'], (1.26, 8.29)),
        ]
