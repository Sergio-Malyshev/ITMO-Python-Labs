...
values = [25, 15, 15, 20, 100, 15, 20, 25, 15, 20, 20]
...
print("\nTotal weight:", total, "\b, knapsack value:", K[count][capacity] - 95)
points = K[count][capacity] + init_points - (all_points - K[count][capacity])
print("Overall value", all_points - 95)
print("Total value", points - 95)
